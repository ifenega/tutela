            ...
            <section className='px-4 md:px-8 lg:px-24  pt-4 md:pt-16 pb-6  flex justify-center items-center flex-col '>
                ...
                <div className='flex gap-5 md:gap-10 flex-col  items-center justify-center 2xl:max-w-[1600px] mt-10 md:mt-20'>
                    ...
                    <div className='flex flex-col gap-5 md:gap-10   2xl:max-w-[1600px] mt-10 md:mt-20 text-xl '>
                        ...
                        <ul className='pl-8'>
                            <li className='text-start list-disc mb-2'>What is ‘content’ in Shop protection plan : Contents in a Shop protection plan refers to the primary items in your shop. For example; if you run a Clothing Boutique, the contents here would refer to all the different garments you have present in your shop, for sale.</li>
                            <li className='text-start list-disc mb-2'>  What do you mean by ‘building’ in Shop protection plan : Building in Shop protection plan refers to the physical aspect of your store.</li>
